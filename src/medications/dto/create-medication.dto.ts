...
export class CreateMedicationDto {
  ...
  @ApiProperty({ 
    example: 'https://cdn.example.com/images/paracetamol.png',
    description: 'URL to the medication image'
  })
  @IsString()
  @IsUrl()
  image_url: string;
  ...
  @ApiProperty({ 
    ...
    required: false, 
    default: true,
    description: 'Whether a prescription is required for this medication'
  })
  @IsOptional()
  @IsBoolean()
